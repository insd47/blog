...
<Image className="px-0!" src={boilerplate} alt="Create Tauri App Template" />
...
<figure className="px-0!">
  <Image src={translucent} alt="translucent window" />
...
<figure className="px-0!">
  <Image src={thumbnail} alt="translucent window" />
...
<figure className="px-0!">
  <Image src={music} alt="translucent window" />
...
<figure className="px-0! -mt-5 mb-0! *:not-last:border-b *:first:border-r grid grid-cols-2">
  <Image src={windows} alt="Tauri Windows App" />
