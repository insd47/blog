...
<figure className="px-0!">
  <Image src={translucent} width={1102} height={810} alt="translucent window" />

  <figcaption className="*:mt-4! *:mb-6! text-center text-xs text-muted-foreground/60">
    투명 배경화면과 Frameless 모드를 적용한 Windows 창
  </figcaption>
</figure>
...
<figure className="px-0!">
  <Image src={thumbnail} width={990} height={850} alt="translucent window" />

  <figcaption className="*:mt-4! *:mb-6! text-center text-xs text-muted-foreground/60">
    SF Symbols를 적용한 어플리케이션 창
  </figcaption>
</figure>
...
<figure className="px-0!">
  <Image src={music} width={1250} height={702} alt="translucent window" />

  <figcaption className="*:mt-4! *:mb-6! text-center text-xs text-muted-foreground/60">
    Windows용 Apple Music
  </figcaption>
</figure>
...
<figure className="px-0! -mt-5 mb-0! *:not-last:border-b *:first:border-r grid grid-cols-2">
  <Image src={windows} width={495} height={425} alt="Tauri Windows App" />
  <Image src={thumbnail} width={495} height={425} alt="Tauri macOS App" />

  <figcaption className="col-span-2 *:mt-4! *:mb-6! text-center text-xs text-muted-foreground/60">
